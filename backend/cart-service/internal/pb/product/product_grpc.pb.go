...
type ProductServiceClient interface {
	// Public / User Facing
	GetProducts(ctx context.Context, in *SearchFilterRequest, opts ...grpc.CallOption) (*ProductList, error)
	GetProductDetail(ctx context.Context, in *GetProductDetailRequest, opts ...grpc.CallOption) (*ProductDetail, error)
	GetProductBatch(ctx context.Context, in *GetProductBatchRequest, opts ...grpc.CallOption) (*ProductBatchResponse, error)
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *SearchFilterRequest, opts ...grpc.CallOption) (*ProductList, error) {
...
func (c *productServiceClient) GetProductBatch(ctx context.Context, in *GetProductBatchRequest, opts ...grpc.CallOption) (*ProductBatchResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productServiceClient) CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*ProductDetail, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductDetail)
...
func (c *productServiceClient) UpdateProduct(ctx context.Context, in *UpdateProductRequest, opts ...grpc.CallOption) (*ProductDetail, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductDetail)
...
type ProductServiceServer interface {
	// Public / User Facing
	GetProducts(context.Context, *SearchFilterRequest) (*ProductList, error)
	GetProductDetail(context.Context, *GetProductDetailRequest) (*ProductDetail, error)
	GetProductBatch(context.Context, *GetProductBatchRequest) (*ProductBatchResponse, error)
	// Admin / Seller Operations
...
func (UnimplementedProductServiceServer) GetProducts(context.Context, *SearchFilterRequest) (*ProductList, error) {
...
func (UnimplementedProductServiceServer) GetProductBatch(context.Context, *GetProductBatchRequest) (*ProductBatchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProductBatch not implemented")
}
func (UnimplementedProductServiceServer) CreateProduct(context.Context, *CreateProductRequest) (*ProductDetail, error) {
...
func _ProductService_GetProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProducts(ctx, req.(*SearchFilterRequest))
	}
