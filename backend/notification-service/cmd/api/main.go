...
import (
	...
	"notification-service/internal/infrastructure/dbms"
...
func main() {
	...
	notificationpb.RegisterNotificationServiceServer(grpcServer, notificationController)
	...
	log.Printf("✅ Notification Service run on port %s 🚀", port)
