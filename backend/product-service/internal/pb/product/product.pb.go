...
const file_proto_product_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x10.product.ProductR\x05value:\x028\x01\"\xc3\x01\n" +
	...
	"\rinitial_stock\x18\b \x01(\x05R\finitialStock\"\xae\x01\n" +
...
var (
	file_proto_product_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
	file_proto_product_proto_goTypes  = []any{
		...
		nil,                             // 13: product.ProductBatchResponse.ProductsEntry
		(*timestamppb.Timestamp)(nil),   // 14: google.protobuf.Timestamp
		(*emptypb.Empty)(nil),           // 15: google.protobuf.Empty
	}
)
var file_proto_product_proto_depIdxs = []int32{
	14, // 0: product.Product.created_at:type_name -> google.protobuf.Timestamp
	14, // 1: product.Product.updated_at:type_name -> google.protobuf.Timestamp
	...
	14, // 6: product.Review.created_at:type_name -> google.protobuf.Timestamp
	0,  // 7: product.ProductList.products:type_name -> product.Product
	13, // 8: product.ProductBatchResponse.products:type_name -> product.ProductBatchResponse.ProductsEntry
	0,  // 9: product.ProductBatchResponse.ProductsEntry.value:type_name -> product.Product
	5,  // 10: product.ProductService.GetProducts:input_type -> product.SearchFilterRequest
	7,  // 11: product.ProductService.GetProductDetail:input_type -> product.GetProductDetailRequest
	8,  // 12: product.ProductService.GetProductBatch:input_type -> product.GetProductBatchRequest
	10, // 13: product.ProductService.CreateProduct:input_type -> product.CreateProductRequest
	11, // 14: product.ProductService.UpdateProduct:input_type -> product.UpdateProductRequest
	12, // 15: product.ProductService.DeleteProduct:input_type -> product.DeleteProductRequest
	6,  // 16: product.ProductService.GetProducts:output_type -> product.ProductList
	1,  // 17: product.ProductService.GetProductDetail:output_type -> product.ProductDetail
	9,  // 18: product.ProductService.GetProductBatch:output_type -> product.ProductBatchResponse
	1,  // 19: product.ProductService.CreateProduct:output_type -> product.ProductDetail
	1,  // 20: product.ProductService.UpdateProduct:output_type -> product.ProductDetail
